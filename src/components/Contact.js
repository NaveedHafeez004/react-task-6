      ...
      <div className="d-flex flex-column flex-sm-row justify-content-between align-items-center">
        <div className="contact-info text-start ms-1">
          ...
          <div className="mb-3 d-flex flex-sm-row flex-column justify-content-center align-items-center">
            <ContactItem icon={faEnvelope} text="joelabrahamkoshy@gmail.com" link="mailto:joelabrahamkoshy@gmail.com" />
            <ContactItem icon={faPhone} text="8547729389" link="tel:8086583425" />
            <ContactItem icon={faLinkedin} text="LinkedIn" link="https://www.linkedin.com/in/joelak07" target="_blank" />
            <ContactItem icon={faGithub} text="GitHub" link="https://github.com/joelak07" target="_blank" />
          </div>
        </div>
